...
for d in range(3):
    ...
    for i, example in enumerate(tqdm(winoground)):
        ...
        print(f'{description}\n\n Which caption is more appropriate: "{caption_0}" or "{caption_1}"? Answer in one sentence.')
        #status = chat.upload_img(image_0, conv, image_list)
        chat.ask(f'{description}\n\n Which caption is more appropriate: "{caption_0}" or "{caption_1}"? Answer in one sentence.', conv)
        ...
        chat.ask(f'Which caption is more appropriate: "{caption_0}" or "{caption_1}"? Answer in one sentence.', conv)
        out_text, out_token = chat.answer(conv=conv,
                                        img_list=image_list,
                                        num_beams=beam_size,
                                        temperature=1,
    ...
    ##################################################################################
        ...
        with open(f"outputs/description_to_prediction_{d}.txt", "w") as f:
