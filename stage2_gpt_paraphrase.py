...
paraphrases = []
with open("chatgpt_outputs/paraphrases_2.txt", "r") as f:
    for line in f:
        #print(line.split("|||"))
...
predictions = []
explanations = []
filenames = os.listdir("all_descriptions")
...
for folder in sorted_filenames:
    ...
    caption_0 = paraphrases[example_num][0]
    caption_1 = paraphrases[example_num][1]
    with open(os.path.join("all_descriptions", folder, "description.txt")) as f:
        description = f.read()
    ...
    with open(os.path.join("chatgpt_outputs", "predictions_paraphrase_2.txt"), "w") as f:
